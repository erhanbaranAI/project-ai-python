...
def detect_objects(image, selected_models, threshold=0.5, thickness=2, color="#00FF00"):
    ...
    graph_figure = plot_results(inference_times, detection_counts)  # Grafiği oluştur
...
with gr.Blocks() as demo:
    ...
    performance_graph = gr.Plot(label="Model Performans Grafiği")  # Gradio'nun desteklediği grafik formatı # Grafik gösterme alanı
    ...
    detect_button.click(
        ...
        outputs=[
            ...
            performance_graph  # Grafiği burada ekledik
        ]
    )
